...
class Melkemun:
    def __init__(self, city_id=2, date_from="2024-05-14", date_to="2025-05-10", limit=20, total_pages=40, delay=1):
    ...
    def process_results(self, results):
        for item in results:
            ...
            if estate_id and estate_id not in self.seen_ids:
                print(f"{self.cnt} : {estate_id}")
    ...
    def run(self):
        for page in range(self.total_pages):
            ...
            results = self.fetch_page(offset)
